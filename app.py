...
# # Process resumes
# def process_resumes(files, job_skills):
#     job_skills_processed = preprocess_text(job_skills)
    
#     scores = []
#     for file in files:
#         text = extract_text_from_pdf(file)
#         skills, _ = clean_and_split_text(text)
#         skills_processed = preprocess_text(skills)

#         similarity = calculate_similarity_with_frequency(job_skills_processed, skills_processed)
...
#     results = process_resumes(files, job_skills)
...
#         if word in synonyms:
#             expanded_text.extend([word, synonyms[word]])
#         else:
...
# def process_resumes():
#     files = request.files.getlist("files")
#     job_skills = preprocess_text(request.form['skills'])
#     job_education = request.form['education']  # Not used in this version, but can be integrated
...
#         similarity = calculate_similarity_with_frequency(job_skills, skills_processed)
#         scores.append({'name': file.filename, 'score': similarity})
