...
//       <div className="flex flex-col items-center justify-center w-full p-6 bg-gradient-to-br">
//         <div className="w-full max-w-[500px] bg-white shadow-lg rounded-xl p-8 transform transition-all duration-500 hover:scale-105 text-black">
//           <h2 className="text-2xl sm:text-3xl font-bold">Upload Your Resumes Folder</h2>
//           <p className="mt-1 text-sm md:text-base">
//             Supported formats - pdf, doc, docx (max file size per file - 2MB).
//           </p>
...
//             <button
//               type="submit"
//               className="bg-[#3B82F6] text-white font-semibold py-2 px-6 rounded-lg duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mt-4 sm:mt-2 w-full sm:w-auto hover:bg-blue-600 hover:shadow-lg transition-all transform hover:scale-105"
//             >
//               Submit
//             </button>
//           </form>
